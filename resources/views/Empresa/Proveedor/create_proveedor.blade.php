...
@section('title', 'Registro de Proveeodr')

@section('content')
<section class="content">
    <form action="{{action('ProveedorController@store')}}" method="post" autocomplete="off" id="empresa" enctype="multipart/form-data">    
        @csrf
        <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <label for="Nombre Productor">Correo Electorinco</label>
                            <input type="text" class="form-control form-control-sm" name="email" placeholder="exampl@email.com">
                    </div>
                </div>
