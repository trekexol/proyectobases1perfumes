...
@section('content')
<div class="card">
    <form action="{{action('FraganciaController@store')}}" method="post" autocomplete="off" id="validate" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="text-sm">Tipo Perfume</label>
                            <select class="custom-select">
                              <option value="perfume">Perfume (P) </option>
                            </select>
                          </div>
                    </div>
                </div>
