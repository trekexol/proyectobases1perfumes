...
@section('content_header')
    <div class="row">
        <div class="col-6">
            <h1>Producto - Fragancia cod: #000-codigo</h1>
        </div>
        <div class="col-6">
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-12 col-sm-6">
                            ...
                            <div class="col-12">
                              <img src="https://www.dior.com/beauty/version-5.1563986503612/resize-image/ep/3000/2000/90/0/%252FY0082217%252FV002%252FY0082217_F008222719_E01_ZHC.jpg" class="product-image" alt="Imagen Producto">
                            </div>
                          </div>
                          <div class="col-12 col-sm-6">
