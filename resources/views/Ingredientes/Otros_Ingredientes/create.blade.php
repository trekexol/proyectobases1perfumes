...
<section class="content">
    <form action="{{action('O_IngredientesController@store')}}" method="post" autocomplete="off" id="ingredientes" enctype="multipart/form-data">    
        @csrf
        <div class="card">
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="nombre" placeholder="Nombre Ingrediente">
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" name="formula_quimica" placeholder="Fórmula Química">
                        </div>
                    </div>
