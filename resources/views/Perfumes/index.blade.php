...
<section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <div class="row">
            <div class="col-9">
              @include('Perfumes.newBtn') 
            </div>
            <div class="col-3">
                <form action="{{ action('PerfumesController@index') }}" method="GET">
                    @method('GET')
                @csrf
      ...
      <div class="card-body p-0" style="display: block;">
        ...
        <table class="table">
            ...
            <tr>
              ...
              <td>{{$var->tipo}}</td>
              <td>{{$var->genero}}</td>
              <td>{{$var->recomendacion}}</td>
              <td class="d-flex justify-content-between">
                  
                   <a class="btn btn-info btn-sm" href="{{action('PerfumesController@edit', $var->id)}}">
