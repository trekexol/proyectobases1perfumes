...
@section('title', 'Editar Ingredientes')
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <form action="{{action('Otros_IngredientesController@update', $var->id)}}" method="post" autocomplete="off">
                    @method('PUT')
                @csrf
            <div class="example_form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="formula_quimica" value="{{$var->formula_quimica}}" id="formula_quimica" placeholder="formula quimica">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="tsca_cas" value="{{$var->tsca_cas}}" id="tsca_cas" placeholder="tsca cas">
            ...
            <div class="row">
                ...
                <div class="card-footer">
                        <div class="form-group">
                                ...
                                <a type="reset" class="btn btn-danger" href="{{action('Otros_IngredientesController@index')}}">
                                    Regresar
                                </a>
